...
################################################################################
## Form generated from reading UI file 'laborCostGui.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget1.setGeometry(QRect(40, 130, 151, 159))
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton_2.setText(QCoreApplication.translate("Form", u"Island Coffee", None))
        self.radioButton.setText(QCoreApplication.translate("Form", u"Scooters", None))
        self.radioButton_3.setText(QCoreApplication.translate("Form", u"Stubbys", None))
